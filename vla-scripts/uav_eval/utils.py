...
def get_glb_path(group, scene):
    ...
    if dataset_type == 'mp3d':
        return f"/VLM/datasets/Indoor_UAV/scene_datasets/mp3d/{scene}/{scene}.glb"
    elif dataset_type == 'gibson':
        return f"/VLM/datasets/Indoor_UAV/scene_datasets/gibson/{scene}.glb"
    elif dataset_type == 'hm3d':
        base_path = f"/VLM/datasets/Indoor_UAV/scene_datasets/hm3d"
        ...
        return f"/VLM/datasets/Indoor_UAV/scene_datasets/replica/{scene}/habitat/mesh_preseg_semantic.ply"
    else:
